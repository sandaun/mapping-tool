 ...
 * Usage: tsx scripts/extract-fixtures-knx-bacnet.ts
 */
...
const FIXTURES_DIR = './src/lib/actions/__tests__/fixtures/knx-from-bacnet';
...
async function extractFixtures() {
  console.log('📖 Llegint CSV de signals BACnet (per KNX)...');
