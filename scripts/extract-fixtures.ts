/**
 * Script per extreure fixtures del workbook real per testing
 * Usage: tsx scripts/extract-fixtures.ts
 */
...
const FIXTURES_DIR = './src/lib/actions/__tests__/fixtures/bacnet-from-modbus';
...
async function extractFixtures() {
  console.log('📖 Llegint CSV de signals Modbus...');
