/**
 * Script per extreure fixtures del workbook BACnet per testing
 * Usage: tsx scripts/extract-fixtures-bacnet-knx.ts
 */
...
const FIXTURES_DIR = './src/lib/actions/__tests__/fixtures/bacnet-from-knx';
...
async function extractFixtures() {
  console.log('📖 Llegint CSV ETS Export (per BACnet)...');
  ...
  console.log('\n✨ Fixtures BACnet creats correctament!');
