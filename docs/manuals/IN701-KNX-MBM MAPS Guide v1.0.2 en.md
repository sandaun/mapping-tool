...
## Configuration Guide
## FOR MODBUS CLIENT TO KNX SYSTEM INTEGRATION
## Version 1.0.2
...
9.3.1. Device Protocol: Modbus .......................................................................................... 27
9.3.1.1. Gateway Configuration ...................................................................................... 27
9.3.1.2. Slave/Server Devices Configuration ...................................................................... 28
9.3.1.3. Modbus Poll Records ......................................................................................... 31
9.3.1.4. Deadband ....................................................................................................... 31
- Signals Tab ........................................................................................................................... 32
- Receive/Send Tab ................................................................................................................. 37
- Diagnostic Tab ...................................................................................................................... 38
...
## •
Looking for the Project Name on the list: IN-KNX-MBM.
...
system (BMS) protocol.
## •
Modbus Master: Configure the parameters for the device
protocol.
...
-  Use the KNX and Modbus Master dropdown menus to choose the needed filters and operations.
## NOTICE
...
## 8.  Click Check.
The Modbus Master Value parameter shows the final result after applying both operations: 860.00 (30°C =
## 86°F; 86×10=860).
...
## 9.3.1. Device Protocol: Modbus
For this protocol combination, the gateway acts like a Modbus Master device.
Figure 13. Modbus configuration parameters
## 9.3.1.1. Gateway Configuration
## •
Modbus Type: Select the communication type.
## –
RTU: Serial communication over the EIA-485 bus.
## –
TCP: IP communication over Ethernet.
## –
Both (RTU+TCP): Simultaneous communication: serial over the EIA-485 bus and IP over Ethernet
simultaneously.
Device Protocol ConfigurationConfiguration Guide
Version 1.0.2Page 27 of 40

9.3.1.2. Slave/Server Devices Configuration
Configuration of the server devices for RTU communication type:
## NOTE
## –
By default, the parameters for the RTU Port B configuration are shown.
## –
Click the checkbox of each element to add or remove it from the installation.
## •
Configuration parameters for ports:
## NOTE
On the tree view, click RTU Port B to open its configuration parameters.
## –
...
## –
Data Type: Select the frame format.
## NOTE
By default, values are 8bit/None/1
Data bitsParityStop bits
8bitNone/Even/Odd1, 2
## –
Time Interframe: Select the minimum time in milliseconds between received and sent frames (0 .. 100000.
Default value: 60 ms).
## –
Poll After Write: Enables or disables a poll for a particular signal after sending a write command to it
(disabled by default).
## –
Slave Currently Read Signal: Generate a new signal indicating the current Modbus server being read
(disabled by default).
## –
Add Device: Select the number of devices to add and click Add (1 .. 255).
## –
Add Device(s): Add devices from a template.
Configuration GuideDevice Protocol Configuration
Page 28 of 40Version 1.0.2

-  Click the Add From Template button.
The Modbus Server Templates window appears.
a.  Click Import file to select a template from a local folder on your PC.
i.   Select the file on your PC.
ii.  Click Open.
b.  Click Download to download a template from the Intesis MAPS repository.
## IMPORTANT
This option requires a connection to the internet.
i.   Filter the search by Manufacturer and Model Name.
ii.  Select the template.
iii.  Click Load.
-  On the Template Available Objects table, uncheck the signals you don't want to import.
3.Import disabled objects: Non-active signals are also imported (enabled by default).
-  Click Apply to import the template.
•Configuration parameters for devices:
## NOTE
On the tree view, click a device to open its configuration.
–Device Name: Type a name for the device.
–Manufacturer: Type the name of the manufacturer.
–Slave Number: Set the device's server number (1 .. 254).
–Clone Device: When cloning a device, a new device with the same configuration is created.
## 1.  Click Clone.
-  Select the number of Devices to Add.
## 3.  Click Apply.
–Export template: Save a template with the device's configuration.
## 1.  Click Export.
-  Type a File name.
-  Select a folder to save the file.
## 4.  Click Save.
–Modbus register base: Select the Modbus addressing type.
•0 based: the first offset of a memory type starts at zero.
•1 based: the first offset of a memory type starts at one.
–Device Timeout: Select the minimum time in milliseconds before launching a timeout message when there
is no response from the server device (100 .. 30000. Default value: 1000 ms).
–Delete Device: Click the Delete button to delete the device.
Device Protocol ConfigurationConfiguration Guide
Version 1.0.2Page 29 of 40

Configuration of the server devices for TCP communication type:
## •
Configuration parameters for nodes:
-  Click the Add Node button below the tree view.
-  Click the node to configure its parameters:
## –
TCP Node Name: Type a name for the node.
## –
TCP Node IP: Set the IP for the node (default IP: 192.168.100.10).
## –
TCP Node Port: Set the port for the node (default port: 502).
## –
Add Device: Select the number of devices to add and click Add (1 .. 255).
## –
## Add Device(s).
## NOTE
The procedure is the same as per RTU communication type. See the procedure description
above.
## –
Advanced configuration: Open advanced configuration parameters (enabled by default).
## •
Time Interframe: Select the minimum time in milliseconds between received and sent frames (0 ..
- Default value: 10 ms).
## •
Retry Timeout: Select the minimum time in milliseconds between retry frames after no response on
the TCP connection (0 .. 30000. Default value: 5000 ms).
## •
Conn. Timeout: Select the minimum time in milliseconds before launching an error message after no
response on the TCP connection (100 .. 30000. Default value: 10000 ms).
## •
RX Timeout: Select the minimum time in milliseconds before launching an error message when no
TCP frames are received but the TCP connection is OK (100 .. 30000. Default value: 5000 ms).
## •
Time Slave Chg: Select the minimum time of silence in milliseconds when changing from one server
device to another one (100 .. 10000. Default value: 100 ms).
## •
Configuration parameters for devices.
## NOTE
The parameters are the same as per RTU communication type. See the parameters' description
above.
Configuration GuideDevice Protocol Configuration
Page 30 of 40Version 1.0.2

## 9.3.1.3. Modbus Poll Records
## •
Enable Poll Records: Activate the poll records request mode for the gateway (disabled by default).
## •
Poll records configuration:
## 1.  Click View.
## Figure 14. Poll Records Configuration
## –
Allow using Poll Records with missing registers: Allow to create Poll Records asking for unused
registers (disabled by default).
## –
Maximum registers in a Poll Record: Set the maximum number of registers contained in each poll
record (2 .. 255. Default value: 100).
-  Click Save to save the changes.
## 9.3.1.4. Deadband
Deadband to send to Internal System: Minimum difference in the new Modbus data received to send the value
to the BMS protocol. Only for non-boolean signals (0.00 .. 1.00. Default value: 0.00).
Device Protocol ConfigurationConfiguration Guide
Version 1.0.2Page 31 of 40

## 10. Signals Tab
This menu lists all available signals and their parameters for both BMS and Device protocols.
Figure 15. Signals tab
...
## NOTE
Some KNX flags may not be selectable depending on the type of the Modbus Master side.
Signals TabConfiguration Guide
Version 1.0.2Page 33 of 40

On the Modbus Master side:
## •
Device: Device associated to this register.
## •
# Slave: Server number of the associated device.
## •
Base: Base of the associated device.
## •
Read Func: Modbus function used to read. The available functions are:
## –
## 1: Read Coils
## –
...
## •
Write Func: Modbus function used to write. The available functions are:
## –
## 5: Write Single Coil
## –
...
## •
Data Length: Size of the register, expressed in bits.
## •
...
4: BitFields
## •
ByteOrder: Endianness type. The available options are:
## –
## 0: Big Endian
## –
## 1: Little Endian
## –
## 2: Word-inverted Big Endian
## –
## 3: Word-inverted Little Endian
Configuration GuideSignals Tab
Page 34 of 40Version 1.0.2

## •
Address: Starting address of the register signal.
...
## Figure 17. Auto Enumeration Parameters
...
Figure 18. Find and replace tool
## NOTICE
...
Figure 19. Diagnostic tab window. Find the ToolBox between the upper tabs bar and the Console view. Below it,
