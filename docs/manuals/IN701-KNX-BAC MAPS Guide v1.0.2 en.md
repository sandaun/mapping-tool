...
## Configuration Guide
## FOR BACNET CLIENT TO KNX SYSTEM INTEGRATION
## Version 1.0.2
...
9.2. BMS Protocol: KNX .......................................................................................................... 26
9.2.1. Device Configuration  ................................................................................................ 26
9.3. Device Protocol Configuration ............................................................................................ 27
9.3.1. Device Protocol: BACnet ............................................................................................ 27
9.3.1.1. General Configuration  ....................................................................................... 28
9.3.1.2. BACnet Explorer ............................................................................................... 28
9.3.1.3. BACnet Devices Configuration ............................................................................. 30
9.3.1.4. Gateway Mode ................................................................................................ 32
- Signals Tab ........................................................................................................................... 33
- Receive/Send Tab ................................................................................................................. 37
- Diagnostic Tab ...................................................................................................................... 38
## Configuration Guide
...
by:
## •
Clicking KNX on the protocol logos.
## •
...
## •
Looking for the Project Name on the list: IN-KNX-BAC.
...
to the gateway yet. To know how to send your project to the gateway, see Receive/Send Tab (page 37).
...
## •
KNX: Configure the parameters for the building management
system (BMS) protocol.
## •
BACnet Client: Configure the parameters for the device
protocol.
...
-  Use the KNX and BACnet Client dropdown menus to choose the needed filters and operations.
## NOTICE
The direction of the conversion depends on the type of the selected object and is indicated by
the black arrows:
•Left to right for KNX write and read/write objects.
- Right to left for KNX read-only objects.
This also determines the active text input in the Test section.
Configuration GuideGeneral Configuration Menu
Page 20 of 40Version 1.0.2
...
In the BACnet Client side:
## •
## Operation: ×10
## •
## Filter: None
-  To test this configuration, type a value of 30 in the KNX Value text field of the Test section.
## 8.  Click Check.
The BACnet Client Value parameter shows the final result after applying both operations: 860.00 (30°C =
## 86°F; 86×10=860).
...
gateway.
General Configuration MenuConfiguration Guide
Version 1.0.2Page 25 of 40

9.2. BMS Protocol: KNX
For this protocol combination, the gateway acts like a KNX server device.
Figure 12. KNX configuration parameters
## 9.2.1. Device Configuration
## •
...
Configuration GuideBMS Protocol: KNX
Page 26 of 40Version 1.0.2

## 9.3. Device Protocol Configuration
9.3.1. Device Protocol: BACnet
For this protocol combination, the gateway acts like a BACnet Client device.
Figure 13. BACnet configuration parameters
Device Protocol ConfigurationConfiguration Guide
Version 1.0.2Page 27 of 40

## 9.3.1.1. General Configuration
Figure 14. General Configuration section
...
inside a single BACnet network segment (0 .. 4194302. Default value: 246).
•Password: Click the Change button and follow the instructions to set a password for the gateway.
•Disable BACnet password (not recommended): Disable the BACnet password (parameter disabled by default).
## IMPORTANT
Keep the BACnet password enabled to ensure the security of the gateway and the installation.
•Enable sequential comms: Allow sequential communication in the BACnet network (disabled by default).
9.3.1.2. BACnet Explorer
Explore BACnet Network: This function scans the bus to discover all the BACnet devices connected to the
installation and the objects of each device.
## NOTE
The search is based on the instance number of the devices present in the network.
Click Explore to open the BACnet Explorer window.
Figure 15. BACnet Explorer
Configuration GuideDevice Protocol Configuration
Page 28 of 40Version 1.0.2

BACnet Explorer Configuration
•Advanced Configuration: Click the Config button to configure the BACnet Explorer Parameters.
Figure 16. BACnet Explorer Parameters
–Start Instance and End Instance: Set these two values to establish the range of search for the BACnet
explorer (default values: 0 and 4194302).
## NOTE
Narrowing the range values will speed up the scan process.
–Step: Specify the number of BACnet devices queried simultaneously during the search (0 .. 65536. Default
value: 65536).
–Scan timeout: Specify, in milliseconds, how long the BACnet explorer will wait for the answer after the
request (0 .. 1000. Default value: 200 ms).
–Retries: Specify the number of retries for the BACnet explorer (1 .. 10. Default value: 3).
## NOTE
The above parameters are the same for BACnet/IP and BACnet MS/TP.
–MSTP Slaves through IP: Enable this parameter to allow the BACnet explorer to discover MS/TP slave
devices using a network number (disabled by default).
•Net Number: Specify which network the BACnet MS/TP explorer has to search in (0 .. 64. Default value:
## 1).
•Start MAC and End MAC: Set these two values to establish the range of MS/TP addresses for the BACnet
explorer (default values: 128 and 254).
•Timeout: Specify, in milliseconds, how long the BACnet MS/TP explorer will wait for the answer after the
request (0 .. 1000. Default value: 200 ms).
–Discover MSTP slaves: Enable this parameter to allow the BACnet explorer to discover MS/TP slave devices
(disabled by default).
•Start MAC and End MAC: Set these two values to establish the range of MS/TP addresses for the BACnet
explorer (default values: 128 and 254).
•Timeout: Specify, in milliseconds, how long the BACnet MS/TP explorer will wait for the answer after the
request (0 .. 1000. Default value: 300 ms).
Once the configuration is done, click Apply to save the changes.
Device Protocol ConfigurationConfiguration Guide
Version 1.0.2Page 29 of 40

•Start BACnet Explorer: Click Start Explore to start the bus scanning.
BACnet Explorer results
After scanning the bus, all the devices found by the BACnet explorer appear listed in the Discovered Devices
table on the left.
To see the objects of the devices, you have two options:
-  Select one device and click the button in the Discover column.
-  Select several devices and click the Discover Selected Devices button at the bottom-left corner of the
window.
## NOTICE
When many devices are selected, obtaining the list of objects may take a long time.
The objects of the device(s) appear listed on the Discovered Objects table on the right.
Allowed actions for the discovered devices:
•Replace Devices: Replace the current list of devices with the newly discovered devices.
•Add Devices: Add the newly discovered devices to the current list of devices.
•Assign Devices: Assign particular discovered devices to particular current devices.
Click Apply to apply the results.
9.3.1.3. BACnet Devices Configuration
## NOTE
- By default, the parameters for the Device 0 configuration are shown.
- Check or uncheck each element of the tree view to add or remove it from the project.
Figure 17. Devices Configuration section
Configuration GuideDevice Protocol Configuration
Page 30 of 40Version 1.0.2

•Device Name: Type a descriptive name for this device.
•Address Type: Choose the address type.
–Device: The BACnet network identifies the device by its instance number.
•Device Instance: Set the BACnet device instance (0 .. 4194302. Default value: 0).
–Address (IP): The BACnet network identifies the device by its network number, IP address, and port.
•Network Number: Specify the network number of the device (0 .. 65535. Default value: 0).
•IP / Port: Set the IP address and port of the device. IP default value: 192.168.100.10. Port default value:
## 47808.
–Address (MSTP): The BACnet network identifies the device by its network number and MAC address.
•Network Number: Specify the network number of the device (0 .. 65535. Default value: 0).
•MSTP MAC Address: (0 .. 255. Default value: 0).
–Address (Other): The BACnet network identifies the device by its network number and an address that is
not an IP or a MAC address.
•Network Number: Specify the network number of the device (0 .. 65535. Default value: 0).
•Other Address: Type the address in hexadecimal format (00 .. ff. Default value: ff).
•Reading Type: Select the service that will be used to read the BACnet server device.
–Polling (ReadProperty).
–COV (Change of Value).
–COV-unconf (Unconfirmed Change of Value).
–Polling Multiple (ReadProperty-Multiple).
•Write Priority: Specify the write priority for this device.
–(none): No priority (default value).
–1 .. 16: Being 1 the highest priority and 16 the lowest priority.
–Rel. Default: Relinquish default.
•Advanced Rel. Def.: Click Edit to open the Advanced Relinquish Default window.
## IMPORTANT
These settings are for advanced users only. We recommend leaving the predetermined
configuration.
–Read Property: Selecting Relinquish Default, the read values will be the Relinquish Default ones instead of
the Present Value ones.
•Time Interframe: Select the minimum time in milliseconds between received and sent frames for this device
(0 .. 100000. Default value: 0 ms).
•Delete Device(s): Click the Delete button to delete the selected device(s).
Adding devices:
-  Click the BACnet Devices root on the tree view.
2.Add Device(s): There are two ways to add devices.
a.  Select the number of devices, then click Add.
b.  Enable the Use EDE File parameter, click Add, and select the EDE file on your computer.
Device Protocol ConfigurationConfiguration Guide
Version 1.0.2Page 31 of 40

## 9.3.1.4. Gateway Mode
Figure 18. Gateway Mode section
## •
Mode: Select the communication type.
## –
IP: IP communication over Ethernet.
## •
UDP Port: Select the UDP port for the BACnet/IP communication.
## NOTE
The UDP port is set to 47808 by default.
## •
Network Role: Define the gateway behavior regarding other network elements.
## IMPORTANT
...
## –
MSTP: Serial communication over the EIA-485 bus.
## •
Baud rate: Select the communication speed: Auto, 9600, 19200, 38400, 57600, 76800, or 115200 bps.
## NOTE
The baud rate is set to Auto by default.
## •
Max. Masters: Set the highest master MAC address in the MS/TP network (1 .. 127. Default value: 127).
## •
Max Info Frames: Set the maximum number of messages to be sent to the MS/TP network per token pass
...
## –
PFM Timeout: Set the polling for master timeout in milliseconds (20 .. 100. Default value: 60 ms).
## –
TP Timeout: Set the token passing timeout in milliseconds (20 .. 100. Default value: 60 ms).
Configuration GuideDevice Protocol Configuration
Page 32 of 40Version 1.0.2

## 10. Signals Tab
This menu lists all available signals and their parameters for both BMS and Device protocols.
Figure 19. Signals tab
...
Figure 20. Auto Group Address window
...
## NOTE
Some KNX flags may not be selectable depending on the type of the BACnet Client side.
Configuration GuideSignals Tab
Page 34 of 40Version 1.0.2

On the BACnet Client side:
## •
Device Name: BACnet object name to be applied to the signal.
## •
Type: BACnet type of the signal. Available types are:
## –
AI: Analog Input
## –
AO: Analog Output
...
## Figure 21. Auto Enumeration Parameters
...
Figure 22. Find and replace tool
## NOTICE
...
Version 1.0.2Page 37 of 40

## 12. Diagnostic Tab
## IMPORTANT
Connection with the gateway is required to use the diagnostic tools.
Figure 23. Diagnostic tab window. Find the ToolBox between the upper tabs bar and the Console view. Below it,
